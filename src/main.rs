...
async fn main(
    ...
    let helius_rpc_url = secrets.get("HELIUS_RPC_URL").expect("secret was not found");

    let solana_rpc_client = SolanaRpcClient::new(&helius_rpc_url, CommitmentConfig::confirmed());
